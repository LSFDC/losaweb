/*
 ...
 Source Server         : lostsaga
 Source Server Type    : SQL Server
 Source Server Version : 16004165 (16.00.4165)
 Source Host           : 192.168.18.23:1433
 Source Catalog        : LosaLogData
 Source Schema         : dbo

 Target Server Type    : SQL Server
 Target Server Version : 16004165 (16.00.4165)
 File Encoding         : 65001

 Date: 04/01/2025 02:47:39
*/
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[GAME_LOG]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_class]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_decoration]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_equip]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_gold]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_buy_item_special]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_cardmatching]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_character]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_cheating]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_localinfo]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_medal]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_pcroom]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_peso]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_play]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_quest]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_roominfo]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_data_time]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[Log_game_concurrent]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_present]', RESEED, 1)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[log_trace_prisoner_start]', RESEED, 1)
GO
